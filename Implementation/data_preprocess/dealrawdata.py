...
def dealrawdata(raw_traindataSet_path, raw_testdataSet_path, traindataSet_path, testdataSet_path, batch_size, maxlen, vector_dim):
    ...
    for filename in os.listdir(raw_traindataSet_path):
        ...
        pickle.dump([X_train, train_labels, funcs, filenames, testcases], f_train,protocol=pickle.HIGHEST_PROTOCOL)
        f_train.close()
    ...
    for filename in os.listdir(raw_testdataSet_path):
        ...
        pickle.dump([X_test, test_labels, funcs, filenames, testcases], f_test,protocol=pickle.HIGHEST_PROTOCOL)
        f_test.close()
...
if __name__ == "__main__":
    ...
    vectorDim = 30
    maxLen = 100
    raw_traindataSetPath = "../data/train/"
    raw_testdataSetPath = "../data/test/"
    traindataSetPath = "../data/dl_input_shuffle/train/"
    testdataSetPath = "../data/dl_input_shuffle/test/"
    os.makedirs(traindataSetPath, exist_ok=True)
    os.makedirs(testdataSetPath, exist_ok=True)
