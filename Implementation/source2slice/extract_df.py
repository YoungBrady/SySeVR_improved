...
def api_slice():
    count = 1
    store_dir="slice_source"
    if not os.path.exists(store_dir):
        os.makedirs(store_dir)
    # os.makedirs(store_dir, exist_ok=True)
    store_filepath = os.path.join(store_dir,"api_slices.txt")
...
def pointers_slice():
    ...
    if not os.path.exists(store_dir):
        os.makedirs(store_dir)
    store_filepath = os.path.join(store_dir,"pointersuse_slices.txt")
...
def arrays_slice():
    ...
    if not os.path.exists(store_dir):
        os.makedirs(store_dir)
    store_filepath = os.path.join(store_dir,"arraysuse_slices.txt")
...
def integeroverflow_slice():
    ...
    if not os.path.exists(store_dir):
        os.makedirs(store_dir)
    store_filepath = os.path.join(store_dir,"integeroverflow_slices.txt")
